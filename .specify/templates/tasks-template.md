...
- [ ] TXXX Observability instrumentation (OpenTelemetry + OpenLLMetry spans for
        prompts, tool calls, sandbox runs)
- [ ] TXXX Validate secrets scopes + egress allowlists per deployment profile
